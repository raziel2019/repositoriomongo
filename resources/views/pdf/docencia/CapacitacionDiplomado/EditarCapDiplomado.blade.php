            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">Actualizar Capacitacion</div>
                    </div>
                <div class="card-body">
                <form action="{{ route('capDiplomado.update',$data->id) }}" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-row">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea class="form-control border border-secondary" id="comment" rows="5" placeholder="Contenido" name="descripcion" required value={{$data->contenido}}>
