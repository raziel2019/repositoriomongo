	...
	<div class="page-inner mt--5">					
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card-body">
                <form action="{{ route('gestion.update',$data->id) }}" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select class="custom-select border border-secondary" id="inputGroupSelect01"  name="gestion" required value={{$data->gestion}}>
                                ...
                                <div class="form-group col-md-4">
                                    <input type="file" class="custom-file-input" name="file" id="validatedCustomFile" required value={{$data->doc}}>
