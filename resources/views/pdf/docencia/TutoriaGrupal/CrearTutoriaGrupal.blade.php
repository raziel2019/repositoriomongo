            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">Tutoria Grupal</div>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('tutoriaG.store') }}" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        @csrf
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    <label for="inputPassword4">Numero de estudiantes</label>
                                    <input type="number" class="form-control border border-secondary" id="inputPassword4" placeholder="Escribir Nombre" name="estudiantes" required>
                                </div>
                                <div class="form-group col-md-4">
