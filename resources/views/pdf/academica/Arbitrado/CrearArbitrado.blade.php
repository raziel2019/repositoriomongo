	...
	<div class="page-inner mt--5">					
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card-body">
                <form action="{{ route('arbitrado.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="form-row">
                            ...
                            <label for="inputPassword4">Para considerar en el currículum de cuerpo académico </label>
                                <select class="custom-select form-control border border-secondary" id="inputGroupSelect01"  name="cv" required>
