	...
	<div class="wrapper">
		<div class="main-header">
			...
			<li>
                <br>
                <label>				
				<p class="text-muted mr-4 font-weight-bold" id="texto">
								@if (Auth::check())
						...
						<li class="nav-item dropdown hidden-caret">
							...
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<div class="dropdown-user-scroll scrollbar-outer">
									<li>
										<div class="user-box">
											<div class="avatar-lg">@if (Auth::check())<img src="{{ url('photo/profile/'.Auth::user()->avatar) }}" alt="image profile" class="avatar-img rounded">@endif</div>
											<div class="u-text">
											<h4>
											@if (Auth::check())
											{{ auth()->user()->name}}
			...
			<div class="sidebar-wrapper scrollbar scrollbar-inner">
				<div class="sidebar-content">
					...
					<ul class="nav nav-primary">
						...
						<li class="nav-item">
							<a href="/gestion_supervisor/list">
						...
						<li class="nav-item">
							...
							<div class="collapse" id="forms">
								<ul class="nav nav-collapse">
									<li>
										<a href="/tutoriaGrupal_supervisor/list">
											<span class="sub-item">Tutoría Grupal</span>
										</a>
									</li>
									<li>
										<a href="/tutoria_supervisor/list">
